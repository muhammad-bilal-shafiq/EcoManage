...
function Createcomp() {
        ...
        const [SWasteDisposed,setSWasteDisposed] = useState('')
        ...
        function handleSubmit(event){
            ...
            axios.post('http://localhost:4000/Createcomp', {Cid,Cname,VCode,SWaste,Em_Total,Tax,Eflag,wflag,Date_Joined,SWasteDisposed,Area,Company_Key,Last_Month_Check,Prev_Method_Installed,CO2,NO2,CO,NO})
            .then(res => {
                navigate('/home')
    ...
    <div className='flex h-100 bg-blue-700 justify-center items-center'>
        <div className='w-60 bg-white rounded p-3'> 
            <form onSubmit={handleSubmit}>
                <p className='text-lg font-bold'>Add New Company</p>
                <div className='mb-2'>
                    <label className='block' htmlFor=''>Cid</label>
                ...
                <div className='mb-2'>
                    <label htmlFor=''>EFlag</label>
                    <input type='text' placeholder='Enter Name' className='form-control'
                    onChange={e=> setEflag(e.target.value)}/>
                </div>
                <div className='mb-2'>
                    <label htmlFor=''>Date_Joined</label>
                    <input type='text' placeholder='Enter Name' className='form-control'
                    onChange={e=> setdatejoined(e.target.value)}/>
                </div>
                <div className='mb-2'>
                    <label htmlFor=''>WFlag</label>
                    <input type='text' placeholder='Enter Name' className='form-control'
                    onChange={e=> setwflag(e.target.value)}/>
                </div>
                <div className='mb-2'>
                ...
                <div className='mb-2'>
                    <label htmlFor=''>Company Key</label>
                    <input type='text' placeholder='Enter Name' className='form-control'
