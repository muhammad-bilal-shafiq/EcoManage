...
function Deletion_log() {
  ...
  useEffect(() => {
    axios.get('http://localhost:4000/deletionlog', { withCredentials: true })
      .then(res => {
      ...
      <div className='container mt-4'>
        ...
        <div>
          <div>
            ...
            <h1 className='text-4xl'>Deletion_log</h1>
                ...
                <table className='min-w-full bg-white border border-gray-300'>
                  <thead className='bg-gray-800 text-white'>
                    <tr>
                      ...
                      <th className='px-6 py-3 text-left'>Total Waste Produced</th>
                      <th className='px-6 py-3 text-left'>Total Emissions</th>
